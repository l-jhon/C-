	...
	void capturarTecla(unsigned char key, int x, int y){
		...
		{
		case 'd':
			// Movimenta todas as janelas da direita
			break;
		case 'e':
			// Movimenta todas as janelas da esquerda
			break;
		case 'p':
			// Movimenta a porta
			break;
	...
	void desenharJanelasLateralEsquerda(){
		   	glPushMatrix();
		        	glColor3f(0, 0, 0);
		        	glBegin(GL_QUADS);
		        	glVertex3f(20, 2, 6);
	...
	// Passar os valores das coordenadas
	void moverJanelaLateralEsquerda(){
		glPushMatrix();
		 	glTranslated(20, 2, 1);
		 	glPushMatrix();
		 		glRotated(90, 0, 1, 0);
		 		desenharJanelasLateralEsquerda();
		 		glEnd();
			glPopMatrix();
			glEnd();
		glPopMatrix();
		...
		glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
	     ...
	     //glRotated(a,0,1,0);
			...
			// Parede da frente do primeiro andar
				...
				//Frente da casa Janela inferior lado direito	        
		        glPushMatrix();
		        	glColor4f(0, 0, 1, 0.5);
		        	glBegin(GL_QUADS);
		        	glVertex3f(15, 2, 12);
	...
	static void idle(void){
		t = glutGet(GLUT_ELAPSED_TIME) / 10000000.0; //Tempo randomico
